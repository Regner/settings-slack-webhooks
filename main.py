...
class WebhooksLookup(Resource):
    def get(self):
        ...
        return {'webhooks': [x['url'] for x in results]}


api.add_resource(Webhooks, '/api/settings/<int:character_id>/slack/webhooks/')
api.add_resource(Webhook, '/api/settings/<int:character_id>/slack/webhooks/<string:webhook_id>/')
